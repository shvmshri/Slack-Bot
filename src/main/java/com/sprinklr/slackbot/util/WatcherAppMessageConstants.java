...
public class WatcherAppMessageConstants {
    ...
    public static final String SLACK_BOT_TOKEN = "xoxb-12438821909-3747468191426-RhxNrbQeYmprJaOO7m3kdyfG";
    public static final String SLACK_SIGNING_SECRET = "8698719275e4c1cfb67443006a703e47";
